...
import useCurrentUser, { currentUserType } from "@/hooks/useCurrentUser";
...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
	...
	return isDesktop ? DesktopSidebar(args) : MobileSidebar(args);
}
...
const DesktopSidebar = ({
	...
	return (
		<Box className="fixed z-40 w-[300px] transition-all duration-300 ease-in-out top-4 left-4 bottom-0 translate-x-0">
...
const MobileSidebar = ({
	...
	<>
		<Box
			className={`
        fixed z-40 w-[300px] transition-all duration-300 ease-in-out top-[84px] left-4 bottom-4
        ${isOpen ? "translate-x-0" : "-translate-x-full"}
      `}
		>
      <div className="h-full rounded-2xl border border-white/10 overflow-hidden pointer-events-auto flex flex-col relative shadow-xl shadow-black/5">				
...
function LogoutButton({
	...
	const baseStyles =
		"group cursor-pointer transition-all duration-200 hover:bg-white/[0.03] rounded-lg";
...
// const previous_return_value = (
// 	<Box
// 		className={`
//         fixed z-40 w-[300px] transition-all duration-300 ease-in-out
//         ${isDesktop ? "top-4 left-4 bottom-0" : "top-[84px] left-4 bottom-4"}
//         ${isOpen ? "translate-x-0" : "-translate-x-full"}
//       `}
// 	>
// 		<div className="h-full bg-gray-900/5 rounded-2xl border border-white/10 overflow-hidden pointer-events-auto flex flex-col relative shadow-xl shadow-black/5">
